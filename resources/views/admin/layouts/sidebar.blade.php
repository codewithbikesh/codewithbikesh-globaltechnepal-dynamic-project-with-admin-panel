<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #09545f;">
    <!-- Brand Logo -->
    <a href="#" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Globaltech Nepal </span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{route('admin.our-team.index')}}" class="nav-link">
